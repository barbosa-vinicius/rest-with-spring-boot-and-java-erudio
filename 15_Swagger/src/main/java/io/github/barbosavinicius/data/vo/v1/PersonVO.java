...
public class PersonVO extends RepresentationModel<PersonVO> implements Serializable {
	...
	public boolean equals(Object o) {
		...
		return getKey().equals(personVO.getKey()) && getFirstName().equals(personVO.getFirstName()) &&
			   getLastName().equals(personVO.getLastName()) && getAddress().equals(personVO.getAddress()) &&
