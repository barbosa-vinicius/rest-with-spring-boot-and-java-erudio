...
import io.github.barbosavinicius.serialization.converter.YamlJackson2HttpMessageConverter;
...
public class WebConfig implements WebMvcConfigurer {
	...
	public void configureContentNegotiation(ContentNegotiationConfigurer configurer) {
		...
		// Via QUERY PARAM/STRING. http://localhost:8080/api/person/v1?mediaType=xml
